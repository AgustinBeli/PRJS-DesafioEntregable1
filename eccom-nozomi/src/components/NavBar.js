            ...
            <nav className="navbar navbar-dark bg-primary grid">
                <ul className="text-light text-center m-0 col-12 list-inline" data-bs-toggle="tooltip">
                    <div className="row d-flex align-items-center">
                        ...
                        <Link className="col-4" to='/category/a' style={{ textDecoration: "none", color: "white" }}><h2 className="nav-link text-light">APPLE</h2></Link>
                        <Link className="col-4" to='/category/b' style={{ textDecoration: "none", color: "white" }}><h2 className="nav-link text-light">XIAOMI</h2></Link>
